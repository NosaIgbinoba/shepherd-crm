...
// side defaults to responsive (bottom sheet on mobile, right panel on
// desktop, split at the same md breakpoint Layout.tsx uses for the nav) —
// pass an explicit side to opt out for a call site that always wants a
// fixed position.
